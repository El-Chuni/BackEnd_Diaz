...
import { ensureUncommon } from "../utils.js";
...
router.post('/post', ensureUncommon, upload.array(), addAProduct);
  
//Se borra un producto especifico por ID
router.delete('/delete/:pid', ensureUncommon, deleteAProduct)

//Se actualiza un producto por ID
router.put('/put/:pid', ensureUncommon, upload.array(), updateAProduct)
